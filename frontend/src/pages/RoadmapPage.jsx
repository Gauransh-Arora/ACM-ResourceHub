    ...
    <>
      <div className="mt-10 mx-4 md:mx-10 sm:flex-row  sm:items-center gap-4">
        ...
        <div className="mb-10 mt-7">
          ...
          <div className="text-[#15A6DD] my-1">HTML | CSS | JavaScript | React | Node.js | Express.js</div>
        ...
        <div className="mb-10">
          ...
          <div className="text-[#15A6DD] font-extrabold my-1">Master the web</div>
          <div className="text-[#9aaebc] flex gap-6 text-[#9aaebc} text-2xl">
            <div>HTML</div>
            <div>HTML</div>
            <div>HTML</div>
            <div>HTML</div>
...
<div> <RoadmapTimeline weeks={weeks} /></div>
        </div>
